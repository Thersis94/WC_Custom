...
update custom.biomedgps_grid set series_10_nm = null where length(series_10_nm) = 0 or series_10_nm = 'null';
update custom.biomedgps_grid set series_9_nm = null where length(series_9_nm) = 0 or series_9_nm = 'null';
update custom.biomedgps_grid set series_8_nm = null where length(series_8_nm) = 0 or series_8_nm = 'null';
update custom.biomedgps_grid set series_7_nm = null where length(series_7_nm) = 0 or series_7_nm = 'null';
update custom.biomedgps_grid set series_6_nm = null where length(series_6_nm) = 0 or series_6_nm = 'null';
update custom.biomedgps_grid set series_5_nm = null where length(series_5_nm) = 0 or series_5_nm = 'null';
update custom.biomedgps_grid set series_4_nm = null where length(series_4_nm) = 0 or series_4_nm = 'null';
update custom.biomedgps_grid set series_3_nm = null where length(series_3_nm) = 0 or series_3_nm = 'null';
update custom.biomedgps_grid set series_2_nm = null where length(series_2_nm) = 0 or series_2_nm = 'null';
update custom.biomedgps_grid set series_1_nm = null where length(series_1_nm) = 0 or series_1_nm = 'null';
