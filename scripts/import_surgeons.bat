...
rem ************ Start Configurable Section for Batch Process *******************
rem This is the ANS lib directory  
set LIB_BASE=E:\Code\Eclipse\SB_ANS_Medical\lib\
...
set JAVA_COMMAND=com.ansmed.sb.datafeed.ImportData

set SB_CP=%SB_CP%.;bin;scripts;%LIB_BASE%D:\Java\JRun4\lib\jrun.jar;
...
set SB_CP=%SB_CP%;%LIB_BASE%commons-net-1.4.1.jar;


rem Build the index
d:\Java\jre1.5.0_07\bin\java -classpath %SB_CP%; %JAVA_COMMAND%