...
public class TransactionReportVO extends AbstractSBReportVO {
	...
	public byte[] generateReport() {
		...
		for (AccountVO acct : data) {
			for (TransactionVO t : acct.getTransactions()) {
				...
				rpt.append("\t<td>").append(TransAction.getStatusName(t.getStatusId())).append("</td>\r");
				...
				rpt.append("\t<td>").append((t.getTransactionTypeId() == 2 ? "Unit Transfer" : "New Unit Request")).append("</td>\r");
	...
	private StringBuilder getHeader() {
		...
		hdr.append("<tr><td colspan='16' style='background-color: #ccc;'><b>MedStream CU Tracking System - Request Summary</b></td></tr>\r");
