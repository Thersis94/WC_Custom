...
/****************************************************************************
 * <b>Title</b>: MarketAttributeTypeVO.java <p/>
...
@Table(name="BIOMEDGPS_MARKET_ATTRIBUTE")
public class MarketAttributeTypeVO {
	...
	public MarketAttributeTypeVO () {
		this.sectionIds = new ArrayList<>();
	}
	
	public MarketAttributeTypeVO (ActionRequest req) {
		setData(req);
	}
