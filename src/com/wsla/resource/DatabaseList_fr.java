...
public class DatabaseList_fr extends SMTBaseResourceBundle {
	
	// Members
    protected static final Logger log = Logger.getLogger(DatabaseList_fr.class);
	
	/**
	 * 
	 */
	public DatabaseList_fr() {
		super();
	}
