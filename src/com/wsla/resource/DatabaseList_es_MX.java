...
public class DatabaseList_es_MX extends SMTBaseResourceBundle {
	
	// Members
    protected static final Logger log = Logger.getLogger(DatabaseList_es_MX.class);
    
	/**
	 * 
	 */
	public DatabaseList_es_MX() {
		super();
	}
