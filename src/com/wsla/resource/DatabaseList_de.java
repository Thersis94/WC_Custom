...
public class DatabaseList_de extends SMTBaseResourceBundle {
	
	// Members
    protected static final Logger log = Logger.getLogger(DatabaseList_de.class);
	
	/**
	 * 
	 */
	public DatabaseList_de() {
		super();
	}
