...
public class DatabaseList_es_DO extends SMTBaseResourceBundle {
	
	// Members
    protected static final Logger log = Logger.getLogger(DatabaseList_es_DO.class);
    
	/**
	 * 
	 */
	public DatabaseList_es_DO() {
		super();
	}
