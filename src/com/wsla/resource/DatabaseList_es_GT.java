...
public class DatabaseList_es_GT extends SMTBaseResourceBundle {
	
	// Members
    protected static final Logger log = Logger.getLogger(DatabaseList_es_GT.class);
    
	/**
	 * 
	 */
	public DatabaseList_es_GT() {
		super();
	}
