...
public class DatabaseList_es extends SMTBaseResourceBundle {
	
	// Members
    protected static final Logger log = Logger.getLogger(DatabaseList_es.class);
	
	/**
	 * 
	 */
	public DatabaseList_es() {
		super();
	}
