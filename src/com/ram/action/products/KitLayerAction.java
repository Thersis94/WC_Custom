...
public class KitLayerAction extends SBActionAdapter {
	...
	public void build(ActionRequest req) throws ActionException {
		...
		try(PreparedStatement ps = dbConn.prepareStatement(sb.toString())) {
			...
			ps.setInt(2, Convert.formatInteger(req.getParameter("layoutDepthNo")));
			ps.setTimestamp(3, Convert.getCurrentTimestamp());
			ps.setInt(4, Convert.formatInteger(req.getParameter("activeFlag")));
			...
			if(rs.next())
				req.setParameter("kitLayerId", rs.getString(1));
