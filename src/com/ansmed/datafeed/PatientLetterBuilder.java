...
public class PatientLetterBuilder {
	...
	protected String scrubXML(String val) {
		...
		val = StringUtil.replace(val, "�", "&#179;");
		val = StringUtil.replace(val, "�", "&#167;");
		val = StringUtil.replace(val, "�", "&#225;");
		val = StringUtil.replace(val, "�", "&#233;");
		val = StringUtil.replace(val, "�", "&#237;");
		val = StringUtil.replace(val, "�", "&#243;");
		val = StringUtil.replace(val, "�", "&#250;");
		return val;
	}
