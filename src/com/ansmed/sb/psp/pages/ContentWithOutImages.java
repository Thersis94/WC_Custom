...
/****************************************************************************
 * <b>Title</b>: ContentWithOutImages.java<p/>
 * <b>Description</b>: Page content without images. 
 * <p/>
 ...
 * <b>Changes: </b>
 ****************************************************************************/
public class ContentWithOutImages extends AbstractPspContent {
	
	public final String STYLES_TEMPLATE_PATH = "scripts/pspStylesNoImages.css";
	
	public ContentWithOutImages() {
		super();
	}
	
    public ContentWithOutImages(PspSiteVO site) {
       	super();
    	siteData = site;
	...
	public PSPContent createContent(ContentType c) {
    	...
    	switch(c) {
	    	case HOME:
	        	...
	        	sb.append("<p>");
	        	sb.append(rewriteDocsPath(StringUtil.checkVal(siteData.getHomeWelcome())));
	        	sb.append("</p>");
	    	...
	    	case OVERVIEW:
	        	...
	        	sb.append("<p>");
	        	sb.append(rewriteDocsPath(StringUtil.checkVal(siteData.getOverviewWelcome())));
	        	sb.append("</p>");
	        	sb.append(CONTENT_END);
	    	...
	    	case GENERAL:
	        	...
	        	if (siteData.getAddInfo() != null && siteData.getAddInfo().length() > 0) {
	        		...
	        		sb.append(StringUtil.checkVal(rewriteDocsPath(siteData.getAddInfo())));
	        		sb.append("<br/><br/>");
	        	}
	    	...
	    	case DISCLAIMER:
	        	...
	        	if(useTitles) {
	       		...
	       		String companyName = StringUtil.checkVal(siteData.getCompanyName());
	       		int index = sb.indexOf("#company#");
	       		while (sb.indexOf("#company#") > -1) {
	       			if(companyName.length() > 0) {
	       				sb.replace(index, (index + 9), companyName.toUpperCase());
	       			} else {
	       				sb.replace(index, (index + 9), "");
	       			}
