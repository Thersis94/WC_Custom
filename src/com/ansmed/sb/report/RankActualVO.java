 ...
 * <b>Changes: </b>
 ****************************************************************************/
public class RankActualVO extends SBModuleVO {
	 ...
	 * @param rs
	 */
	public RankActualVO(ResultSet rs) {
		super();
		actualsData = new ActualsVO();
		setData(rs);
	}
	...
	public void addPlanData(String field, String value) {
		...
		if (field.equalsIgnoreCase("physAnlRevGoal")) {
			...
			this.setRevenueTarget(Convert.formatInteger(value).intValue());
		} else {
