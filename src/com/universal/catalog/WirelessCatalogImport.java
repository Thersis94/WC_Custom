 ...
 *
 */
public class WirelessCatalogImport extends CatalogImport {
	
	public WirelessCatalogImport() {
		this.loadMaps();
	}
	...
	private void loadProducts() {
		...
		products.put("custProdNo",15);
		products.put("metaKeywords",29);
		products.put("image",30);
		products.put("thumbNail",32);
		products.put("urlAlias",1);
		products.put("children",19);
		products.put("category",20);
