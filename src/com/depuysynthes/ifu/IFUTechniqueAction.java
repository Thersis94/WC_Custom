...
public class IFUTechniqueAction extends SBActionAdapter {
	...
	public void update(ActionRequest req) throws ActionException {
		update(new IFUTechniqueGuideVO(req));
		Object msg = attributes.get(AdminConstants.KEY_SUCCESS_MESSAGE);
		adminRedirect(req, msg, buildRedirect(req));
	}
	...
	private void updateXR(IFUTechniqueGuideVO vo, boolean isInsert) throws SQLException {
		String sql = buildXRSql(isInsert);
	...
	private String buildXRSql(boolean isInsert) {
		String customDb = (String) getAttribute(Constants.CUSTOM_DB_SCHEMA);
		StringBuilder sql = new StringBuilder(150);
	 ...
	 * @return
	 */
	private String buildTGSql(boolean isInsert) {
		String customDb = (String) getAttribute(Constants.CUSTOM_DB_SCHEMA);
		StringBuilder sql = new StringBuilder(150);
		if (isInsert) {
