 ...
 * <b>Changes: </b>
 ****************************************************************************/
public class SheetsLoginModule extends AbstractLoginModule {

	/**
	 * 
	 */
	public SheetsLoginModule() {
	 ...
	 * @param initVals
	 */
	public SheetsLoginModule(Map<String, Object> initVals) {
		super(initVals);
		this.setUserProfile(true);
	}
	...
	throws AuthenticationException {
		WebServiceManager wsa = new WebServiceManager();
		UserDataVO user = null;
		try {
			user = wsa.authenticate(loginName, password);
		} catch (Exception e) {
			// set loginName as authenticationId for logging purposes.
			user = new UserDataVO();
