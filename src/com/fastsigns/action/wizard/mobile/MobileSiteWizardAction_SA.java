...
public class MobileSiteWizardAction_SA extends MobileSiteWizardAction {
	
	/**
	 * Localization Text Set
	 */
	public MobileSiteWizardAction_SA() {
		FS_SITE_ID = "FTS_SA";
	 ...
	 * @param actionInit
	 */
	public MobileSiteWizardAction_SA(ActionInitVO actionInit) {
		super(actionInit);
		FS_SITE_ID = "FTS_SA";
		FS_GROUP = "FAST_SIGNS_SA";
	...
	public void assignTypes() {
		defDisplay.add(makePageModule(true, true, true, "0a001413d979750238f6a6114e82b554","c0a80a07614b3c24224dd3d77221237a", "HEADER_LEFT", 0, 1));	//Mobile Header Left
		defDisplay.add(makePageModule(true, true, true, "0a001413d979750138f6a61167d314d4","c0a80a07614b3c24224dd3d77221237a", "COPYRIGHT", 0, 1));		//Mobile Copyright
		//defDisplay.add(makePageModule(true, true, true, "0a001413d979750238f6a611296cf594","c0a80a07614b3c24224dd3d77221237a", null, 0, 1));			//Mobile Find Location Bar
		...
		secDisplay.add(makePageModule(true, true, true, "0a001413d979750238f6a6114e82b554","c0a80a07614b3c24224dd3d77221237a", "HEADER_LEFT", 0, 1));	//Mobile Header Left
		secDisplay.add(makePageModule(true, true, true, "0a001413d979750138f6a61167d314d4","c0a80a07614b3c24224dd3d77221237a", "COPYRIGHT", 0, 1));		//Mobile Copyright
		//secDisplay.add(makePageModule(true, true, true, "0a001413d979750238f6a611296cf594","c0a80a07614b3c24224dd3d77221237a", null, 0, 1));			//Mobile Find Location Bar
