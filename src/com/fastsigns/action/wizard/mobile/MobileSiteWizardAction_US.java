 ...
 ****************************************************************************/
public class MobileSiteWizardAction_US extends MobileSiteWizardAction {
	
	/**
	 * Localization text set
	 */
	public MobileSiteWizardAction_US() {
		FS_SITE_ID = "FTS";
		FS_GROUP = "FAST_SIGNS";
	 ...
	 * @param actionInit
	 */
	public MobileSiteWizardAction_US(ActionInitVO actionInit) {
		super(actionInit);
		FS_SITE_ID = "FTS";
		FS_GROUP = "FAST_SIGNS";
		posMsg1 = "You have successfully created the mobile site: ";
	...
	public void assignTypes() {
		defDisplay.add(makePageModule(true, true, true, "c0a802371c26a4eec2a4c6c4e1c82d68", "c0a80a07614b3c24224dd3d77221237a", "HEADER_LEFT", 0, 1));	//Mobile Header Left
		defDisplay.add(makePageModule(true, true, true, "c0a802371c2839e6337d5c66331d6b72", "c0a80a07614b3c24224dd3d77221237a", "COPYRIGHT", 0, 1));	//Mobile Copyright
		//defDisplay.add(makePageModule(true, true, true, "c0a8023730278b6978f0d485142d5608","c0a80a07614b3c24224dd3d77221237a", null, 0, 1));			//Mobile Find Location Bar
		...
		secDisplay.add(makePageModule(true, true, true, "c0a802371c26a4eec2a4c6c4e1c82d68","c0a80a07614b3c24224dd3d77221237a", "HEADER_LEFT", 0, 1));	//Mobile Header Left
		secDisplay.add(makePageModule(true, true, true, "c0a802371c2839e6337d5c66331d6b72","c0a80a07614b3c24224dd3d77221237a", "COPYRIGHT", 0, 1));		//Mobile Copyright
		//secDisplay.add(makePageModule(true, true, true, "c0a8023730278b6978f0d485142d5608","c0a80a07614b3c24224dd3d77221237a", null, 0, 1));			//Mobile Find Location Bar
