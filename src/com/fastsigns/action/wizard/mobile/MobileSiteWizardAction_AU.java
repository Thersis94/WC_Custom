 ...
 ****************************************************************************/
public class MobileSiteWizardAction_AU extends MobileSiteWizardAction {
 
	/**
	 * Localization Text Set
	 */
	public MobileSiteWizardAction_AU() {
		FS_SITE_ID = "FTS_AU";
	 ...
	 * @param actionInit
	 */
	public MobileSiteWizardAction_AU(ActionInitVO actionInit) {
		super(actionInit);
		FS_SITE_ID = "FTS_AU";
		FS_GROUP = "FAST_SIGNS_AU";
		emailSuffix = "@signwave.com.au";
	...
	public void assignTypes() {		
		defDisplay.add(makePageModule(true, true, true, "0a0014137c77506ded1c4b274377c76d","c0a80a07614b3c24224dd3d77221237a", "HEADER_LEFT", 0, 1));	//Mobile Header Left
		defDisplay.add(makePageModule(true, true, true, "0a0014137c77506ced1c4b27d1a32b73","c0a80a07614b3c24224dd3d77221237a", "COPYRIGHT", 0, 1));		//Mobile Copyright
		//defDisplay.add(makePageModule(true, true, true, "0a0014137c77506ded1c4b274c69e304","c0a80a07614b3c24224dd3d77221237a", null, 0, 1));			//Mobile Find Location Bar
		...
		secDisplay.add(makePageModule(true, true, true, "0a0014137c77506ded1c4b274377c76d","c0a80a07614b3c24224dd3d77221237a", "HEADER_LEFT", 0, 1));	//Mobile Header Left
		secDisplay.add(makePageModule(true, true, true, "0a0014137c77506ced1c4b27d1a32b73","c0a80a07614b3c24224dd3d77221237a", "COPYRIGHT", 0, 1));		//Mobile Copyright
		//secDisplay.add(makePageModule(true, true, true, "0a0014137c77506ded1c4b274c69e304","c0a80a07614b3c24224dd3d77221237a", null, 0, 1));			//Mobile Find Location Bar
