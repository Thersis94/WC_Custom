...
public class PageContainerVO_en_GB extends PageContainerVO{
	...
	public Map<String, String> getCustomVals(){
		...
		vals.put("loginPmid", "0a00141332b1fb5f4008c75cda601db9");	//Pmid for parent org's login module.
		return vals;
	}
