...
public class PageContainerVO_en_AE extends PageContainerVO {
	...
	public Map<String, String> getCustomVals(){
		...
		vals.put("loginPmid", "3c83ebed9eb543139cf3693dcf1cdcaf");	//Pmid for parent org's login module.
		return vals;
	}
