 ...
 * <b>Changes: </b>
 ****************************************************************************/
public class PageContainerVO_m_en_US extends PageContainerVO{

	private static final long serialVersionUID = 1L;
	protected static final Logger log = Logger.getLogger(PageContainerVO_m_en_US.class);
	
	public PageContainerVO_m_en_US() {
		assignTypeVals();
		sharedId = "FTS_SHARED";
	}
	...
	public Map<String, String> getCustomVals(){
		 ...
		 * vals.put("loginPmid", PageContainerVO_en_US.LOGIN_MOD_ID );	//Pmid for parent org's login module.
		 */
		return vals;
	}
...
/****************** FASTSIGNS BUSINESS LOGIC **********************************/
	...
	public Map<String, Integer> getBusinessLogic() {
		...
		pgs.put("View Photo Gallery", CUSTOM_TEMPLATED);
	...
	public void assignTypeVals() {
		bizRules.put("View Photo Gallery", makePage("gallery", "View Photo Gallery", null)); //Gallery Content	
