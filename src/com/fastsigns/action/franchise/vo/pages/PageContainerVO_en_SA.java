...
public class PageContainerVO_en_SA extends PageContainerVO {

	private static final long serialVersionUID = 1L;
	protected static final Logger log = Logger.getLogger(PageContainerVO_en_GB.class);
	
	public PageContainerVO_en_SA() {
		assignTypeVals();
		sharedId = "FTS_SHARED_SA";
	}
	...
	public Map<String, String> getCustomVals(){
		...
		vals.put("loginPmid", "0a001413d97cbaad38f6a61176785da1");	//Pmid for parent org's login module.
		return vals;
	}
...
/****************** FASTSIGNS BUSINESS LOGIC **********************************/
	...
	public void assignTypeVals() {
		...
		bizRules.put("Learning Centre",makePage("LearningCenter", "Learning Centre", "/LearningCenter"));  //corp
