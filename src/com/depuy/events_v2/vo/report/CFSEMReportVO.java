...
public class CFSEMReportVO extends AbstractSBReportVO {
	...
	public byte[] generateReport() {
		...
		sb.append("</div>");
		sb.append("<div id='requirements'>To the best of my knowledge, the <i>DePuy Synthes Joint Reconstruction</i> (Co-funded) Patient Education Seminar scheduled for<br/>");
