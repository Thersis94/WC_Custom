 ...
 * @since Jan 31, 2014
 ***************************************************************************/
public class MitekESEMReportVO extends AbstractSBReportVO {
	...
	public byte[] generateReport() {
		...
		sb.append("Synthes Mitek Sports Medicine</i> newspaper ad. No changes can be made to the pre-approved newspaper ad.</li>");
		...
		sb.append("<li>The speaker will be required to sign a legal approved agreement sent to them by Early Intervention Marketing ");
		sb.append("or given to them by their Early Intervention Sales Consultant.</li>");
		...
		//Footer
		sb.append("<br/><br/>");
		sb.append("Area Marketing Director's Signature: <u>&nbsp; &nbsp;${admSignature}&nbsp; &nbsp;</u> Date: <u>&nbsp; &nbsp;${approvalDt}&nbsp; &nbsp;</u><br/>");
